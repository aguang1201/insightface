...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir',
                        default='/media/ys1/YS1_Internal_Storage_4T/dataset/face_dataset/iccv19-challenge-data/01',
                        type=str, help='Directory with unaligned images.')
    parser.add_argument('--output-dir',
                        default='/media/ys1/YS1_Internal_Storage_4T/dataset/face_dataset/iccv19_mtcnn_112_01', type=str,
